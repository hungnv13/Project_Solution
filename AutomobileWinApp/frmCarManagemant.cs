...
using Project_ClassLibrary.Repository;

namespace AutomobileWinApp
{
    public partial class frmCarManagemant : Form
    {
        ICarRepository carRepository = new CarRepository();
        BindingSource source;
        public frmCarManagemant()
        {
            InitializeComponent();
        }

        private void frmCarManagemant_Load(object sender, EventArgs e)
        {
